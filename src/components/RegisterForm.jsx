      ...
      >
        ...
        <form id="register-form" className="space-y-4 w-[90%] mx-auto" onSubmit={handleSubmit(onSubmit)}>
          ...
          <input
            ...
            type="text"
            placeholder="DNI:"
            {...register('dni', { required: 'Campo obligatorio', pattern: { value: /^\d{8}[A-Za-z]$/, message: 'Formato de DNI no válido (8 cifras y una letra)' } })}
          ...
          <input
            ...
            {...register('email', { required: 'Campo obligatorio', pattern: { value: /^[^@]+@[^@]+\.[a-zA-Z]{2,}$/, message: 'Correo no válido' } })}
            className="w-full px-4 py-2 rounded-md border border-gray-300 bg-[#EEF0FF] text-[#00174B] focus:outline-none focus:ring-2" />
          ...
          <input
            ...
            {...register('password', { required: 'Campo obligatorio', minLength: { value: 8, message: 'La contraseña debe tener al menos 8 caracteres' } })}
            className="w-full px-4 py-2 rounded-md border border-gray-300 bg-[#EEF0FF] text-[#00174B] focus:outline-none focus:ring-2" />
