    ...
    <div id="register-form-container" className="form-container flex items-center justify-center bg-white relative font-bree p-8">
      <div
        ...
        <form id="register-form" className="space-y-4 w-[90%] mx-auto" onSubmit={handleSubmit(onSubmit)}>
          ...
          <div id="submit-button-container" className="send-form-register flex justify-center"> <button id="submit-button" type="submit" className="w-[30%] bg-[#00328C] text-white py-2 rounded-full hover:opacity-90 transition font-bree"> Enviar </button> </div>
        </form>
        {errorMessage && (
