...
export const RegisterForm = () => {
  ...
  return (
    <div
      ...
      className="form-container flex items-center justify-center bg-white relative font-bree p-6 sm:p-8"
    >
      <div
        id="register-form-card"
        className="bg-[#E1E5FF] p-6 rounded-2xl w-full max-w-md shadow-lg border border-gray-300 max-h-[90vh] overflow-y-auto"
      >
        <h2
          id="form-title"
          className="text-2xl font-bold text-center text-[#00174B] mb-6"
        >
          Registrarse
        </h2>
        ...
        <form
          id="register-form"
          className="space-y-5 w-[90%] mx-auto"
        ...
        >
          ...
          <div id="submit-button-container" className="flex justify-center">
            <button
              id="submit-button"
              type="submit"
              className="w-1/3 bg-[#00328C] text-white py-2 rounded-full hover:opacity-90 transition font-bree"
            >
              Enviar
            </button>
          </div>
        ...
        <p
          id="login-link-paragraph"
          className="text-center mt-4 text-sm text-[#00174B]"
        >
