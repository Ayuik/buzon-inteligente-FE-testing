...
This projetc simulates the end-to-end workflow of a smart package delivery system, including:

- Web platform for user registration, login, dashboard access, and package management.
- Locker terminal interface for couriers to deposit and recipients to collect packages.
...
- Create an intuitive dashboard for users to manage packages.
- Allow couriers to deliver packages through a locker interface.
- Enable recipients to retrieve packages using a permanent credential.
- Provide a full CRUD system for package generation and tracking.
...
![Figma-Aequímedes](https://github.com/user-attachments/assets/c0e4ed1f-4955-4d67-874b-65debc1c8dc7)
